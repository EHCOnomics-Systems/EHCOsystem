...
- `architecture/runtime-repository-and-test-estate-boundary.md` — ownership map across Runtime, public repository, controlled source/test estates, downstream components and evidence packets.
...
- `assurance/` — AI-OS and ecosystem claim/evidence navigation.
