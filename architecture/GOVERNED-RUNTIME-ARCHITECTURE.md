...
and component effects       dashboards / public views
          ...
          +----------+-----------+
                     ...
                     v
              EVIDENCE RECORDS
         source-bound and scope-bound
```

## Tier One — Runtime Authority

Tier One owns admission and standing, authority and scope, recognized Runtime state, lawful transition and consequence, persistence and continuity, withholding/release, correction/recovery, and Runtime-originated proof.

## Downstream governed components

Downstream governed components own computational language, range/reasoning, retrieval/evidence, memory/continuity, relationship, coordination, research and domain-application capability. Scoped Runtime participation is established through the applicable Runtime corridor and owning Runtime evidence.
