...
proof_ceiling: category and architecture definition; not implementation evidence, legal certification, deployment evidence, or Runtime proof
---
...
The `EHCOsystem` repository is a public architecture, evidence, provenance, research, verification, and publication surface. It is not the EHCO AI-OS Runtime and does not acquire Runtime authority by describing Instantiated AI.
...
- [EHCO Language-Model System Boundary](../language-model/README.md) — separation between the language model and the governing system.
