...
- [Components and Runtime Relationships](architecture/ecosystem-components-and-participation.md)
...
## Historical evidence and architecture depth

- [Public Evidence landing page](evidence/README.md)
- [Historical Public Evidence Companion Packets 00–08](evidence/public-evidence-companion/v1/)
...
- [Canonical Public Publication Register](releases/PUBLIC-RELEASE-REGISTER.md)
