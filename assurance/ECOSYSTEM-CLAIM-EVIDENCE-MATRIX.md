...
| EHCO Range Reactor | Mature deterministic proof-carrying implication, reachability, range, and reasoning system | Mature established component capability | Accepted component qualification evidence | [Range Reactor](../range-reactor/README.md) | RR snapshot + operational closure validators |
| Range Reactor matched A/B | Selected workload demonstrates deterministic reduction with preserved selected semantics; accepted host evidence ties the physical benchmark execution to the local Windows/WSL2 Docker portability environment without identifying a specific physical device model | **14.304307x wall**, **14.208722x CPU**, **94.755854%** Python peak-allocation reduction, **1,957→64** states, **1,956→192** transitions, **720 histories preserved** | Accepted physical matched-workload benchmark evidence + owning host-custody environment evidence | [RR Operational Closure](../range-reactor/evidence/operational-closure-v1/README.md) | `validate_public_range_reactor_operational_closure.py` + owning host evidence |
| Range Reactor semantic closure | Selected semantic closure corpus completes deterministically | **82 passed / 0 failed** | Accepted selected-corpus semantic evidence | [RR Operational Closure](../range-reactor/evidence/operational-closure-v1/README.md) | `validate_public_range_reactor_operational_closure.py` |
| EHCO RAG | Governed retrieval, context, provenance, source custody, and evidence capability | Accepted controlled component baseline | Governed component architecture/source | [Technology Estate](../architecture/EHCO-TECHNOLOGY-ESTATE.md) | Architecture review |
| EHCO Prime | Persistent relationship continuity and individual-facing coordination | Mature source/control capability | Governed component architecture/source | [Technology Estate](../architecture/EHCO-TECHNOLOGY-ESTATE.md) | Architecture review |
| EHCO Agent Connect | Registry, discovery, compatibility, health observation, and candidate routing | Mature source/control capability | Governed component architecture/source | [Technology Estate](../architecture/EHCO-TECHNOLOGY-ESTATE.md) | Architecture review |
| Research foundations | EHCO Memory, Primordia, Recursion, and Fractal Systems supply governed research foundations | Established source/research estates | Governed research architecture/source | [Technology Estate](../architecture/EHCO-TECHNOLOGY-ESTATE.md) | Architecture review |
| Governed applications | Domain systems apply the shared instantiated architecture and technology spine | Modular application estate | Governed application architecture/source | [Technology Estate](../architecture/EHCO-TECHNOLOGY-ESTATE.md) | Architecture review |
| Public repository | Public representation is coherent, public-safe, and machine-checkable for an exact revision | Qualified repository candidate | Repository validation | [Verification](../verification/README.md) | `python3 verification/verify_all_public.py` |
